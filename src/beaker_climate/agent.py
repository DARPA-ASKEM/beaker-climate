...
from cartwright.schemas import GeoSpatialResolution
...
class ClimateDataUtilityAgent(BeakerAgent):
    ...
    async def detect_resolution(self, filepath: str, geo_columns: dict, agent: AgentRef) -> str:
        ...
        Returns:
            str: The inferred geospatial resolution of the dataset. Includes whether the resolution is uniform and resolution value and units.
