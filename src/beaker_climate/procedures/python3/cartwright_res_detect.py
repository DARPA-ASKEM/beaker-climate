...
result_string = f"The spatial uniformity of the dataset is {resolution.square.uniformity} with a resolution of {resolution.square.resolution} and units of {resolution.square.unit} degrees. The resolution error is {resolution.square.error}."
